...
let first = true;
let hrefLink = "https://eliotakira.com/neko/";
function spawnOnce() {
  if (!first) return;
  first = false;
  ...
  (function oneko() {
    ...
    let mousePosX = linkRect.right;
    let mousePosY = linkRect.bottom;
    ...
    function idle() {
      ...
      if (
        ...
        if (nekoPosX > window.innerWidth - 64) {
          avalibleIdleAnimations.push("scratchWallE");
        }
        if (nekoPosY > window.innerHeight - 64) {
